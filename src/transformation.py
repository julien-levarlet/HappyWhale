...
class Transformation():
    ...
    def __init__(self,number_of_generation=1,transformation_list=[],angle=(-5,5),start_pose=1,translation_range=(-20,20),shear_range=(-0.1,0.1),contrast_range=(0.8,1.3),brightness_range=(0.9,1.2),sharpness_range=(0.85,1.1), color_range=(0.85,1.2),image_size=(512,512)):
